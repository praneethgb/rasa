...
* or you can explore Rasa Open Source online using our protyper. At the end of the
  tutorial you can download the resulting assistant and continue development locally.
